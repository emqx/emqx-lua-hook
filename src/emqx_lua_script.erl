...
-export([register_on_message_publish/2, register_on_client_connected/2,
         ...
         register_on_session_unsubscribed/2, register_on_client_authenticate/2,
         register_on_client_check_acl/2, unregister_hooks/1]).
...
-export([on_message_publish/3, on_message_deliver/4, on_message_acked/4,
         ...
         on_client_authenticate/3, on_client_check_acl/6]).
